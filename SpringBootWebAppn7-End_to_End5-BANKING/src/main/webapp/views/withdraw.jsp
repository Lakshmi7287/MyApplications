...
<body style="background:rgb(142, 147, 147)">
    <h1  style="color:red" >WITHDRAWW FORM</h1>
    <form action="Viewwithdraw" >
        ...
        <tr> <td><input type="submit" value="submit" style="background:Green">&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><input type="reset" value="clear" style="background:red"></td></tr>
        </table>
        </form>
    </body>
    </center>